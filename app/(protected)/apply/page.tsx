...
export default async function ApplyPage({
  ...
  const isRejected =
    user.status === UserStatus.REJECTED || user.status === UserStatus.SUSPENDED;
  ...
  return (
    <main className="app-shell">
      <section className="app-card">
        ...
        {isRejected ? (
          <p>
            Your application was not approved. Reach out to the ShardUp team if you
            think this needs another look.
          </p>
        ) : isSubmitted ? (
          <>
          ...
          <>
            <p>
              Tell us about yourself. Approved members get access to the community
